...
using KenkoWebApp.Data;
using KenkoWebApp.Models;
using Microsoft.AspNetCore.Http;

namespace KenkoWebApp.Controllers
{
    public class HealthRecordsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title")] HealthRecord healthRecord, List<IFormFile> fileInputData)
        {
